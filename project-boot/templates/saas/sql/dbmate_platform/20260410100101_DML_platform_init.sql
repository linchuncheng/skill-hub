...
VALUES
    (0, 'default', '多租户SaaS平台', '', '超级管理员', '', 1, NOW(), NOW());
...
VALUES
    (1, '0', 'admin', '$2a$10$ldCOp30.Vefq5fGWWlrpDeSHBNLR0HG.zBoUMsgUsHuM1WtndHVF2', '超级管理员', '', '13800000001', 'admin@fengqun.com', '超级管理员账号', 1, 'PLATFORM', NOW(), NOW());
